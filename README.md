> 提醒： 滥用可能导致账户被BAN！！！   
  ...
  [原始脚本](https://github.com/mixool/kuhero),该项目使用[v2yay](https://github.com/v2fly/v2ray-core)+caddy，同时部署通过ws传输模式的vmess vless trojan-go shadowsocks socks等协议。
...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/lkjuyhjt/proxy_heroku)  
